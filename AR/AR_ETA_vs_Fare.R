...
input <- read.csv("/Users/r.nacheva/Downloads/ETA_vs_Fare_2022_06_29.csv")
...
input$req_can = input$Rides + input$pax_can 

# Create ratio KPIs: 

kpi_name = c('AccR','Eta_acc','Utilisation','Avg_ride_distance','Avg_basicFare_ride','Surge_Onride','Rides_wSurge','Avg_fare_ride')  # same name as inserted in the balancing
kpi_nominator = c('acc','eta_acc','Active_hours','ride_total_distance','sum_basic_fare','sum_surge_amount','rides_surge','sum_fare_ride') # same as in data set
kpi_denominator = c('broadcast','acc','Supply_hours','Rides','Rides','rides_surge','Rides','Rides') # same as in data set
...
kpis <-c("Rides" ,"Supply_hours","Revenue", "driver_earning",'Utilisation' ,'AccR',
         'Eta_acc','acc','broadcast','pax_can','Avg_ride_distance','Avg_basicFare_ride'
         ,'Surge_Onride','Rides_wSurge','Avg_fare_ride'
)
...
outputname <- '/Users/r.nacheva/Downloads/Results_Test_Show_Fare_AR_weekend_220629_v1.csv'
