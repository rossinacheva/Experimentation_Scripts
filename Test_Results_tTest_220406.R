...
input <- read.csv("/Users/r.nacheva/Downloads/Skip_Request_2022_03_31.csv")
...
input$req_can = input$rides + input$pass_cancelled_ride + input$dr_cancelled_ride

# Create ratio KPIs: 

kpi_name = c('RejRate','AccR','IngR','Time_to_acc','Time_to_rej','Pass_CancR','Dr_CancR')  # same name as inserted in the balancing
kpi_nominator = c('rejected','accepted','ignored','sum_time_to_accept','sum_time_to_reject','pass_cancelled_ride','dr_cancelled_ride') # same as in data set
kpi_denominator = c('total_broadcasts','total_broadcasts','total_broadcasts','accepted','rejected','req_can','req_can') # same as in data set
...
kpis <-c('RejRate','AccR','IngR','rejected','accepted','ignored','total_broadcasts','Time_to_acc','Time_to_rej','rides','revenue',
...
Treatment_name = 'test_with_comms'
...
outputname <- '/Users/r.nacheva/Downloads/Results_Test_220501.csv'
