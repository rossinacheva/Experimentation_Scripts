...
input<- read.csv("/Users/r.nacheva/Downloads/Increase_CC_Penetration_Comms_2022_10_12.csv")
...
segmentation <-  list(segment1 = c('cc_in_app')
)
...
kpi_name = c('percentage_cc_calc')  # same name as inserted in the balancing
kpi_nominator = c('cc_rides') # same as in data set
...
balancing <- c("cc_rides","cash_rides","rides","percentage_cc",'percentage_cc_calc')
...
outputname <- '/Users/r.nacheva/Downloads/Balancing_CO_cc_penetration.csv'
