...
input<- read.csv("/Users/r.nacheva/Downloads/[RL]_Drivers_per_timeframe_2022_07_27.csv")
...
segmentation <-  list(segment1 = c('driver_timeframe')
)
...
balancing <- c("supply_hours" ,"early_supply_hours" ,"late_supply_hours" ,"early_rides_hours" , "late_rides_hours"  
               ,"availability_hours" )
